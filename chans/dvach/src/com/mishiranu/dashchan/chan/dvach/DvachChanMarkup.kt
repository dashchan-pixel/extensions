...
class DvachChanMarkup : ChanMarkup() {
	...
	override fun isTagSupported(boardName: String?, tag: Int): Boolean = (SUPPORTED_TAGS and tag) == tag
	...
	companion object {
		private val SUPPORTED_TAGS = TAG_BOLD or TAG_ITALIC or TAG_UNDERLINE or TAG_OVERLINE or
