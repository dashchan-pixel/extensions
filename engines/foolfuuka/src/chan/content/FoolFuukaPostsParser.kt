...
open class FoolFuukaPostsParser(linked: Any?) : PostsParser {
    ...
    @Throws(IOException::class, ParseException::class)
    override fun convertPosts(input: InputStream, threadUri: Uri?): Posts? {
        PARSER.parse(InputStreamReader(input), this)
    ...
    companion object {
        ...
        private val PARSER: TemplateParser<FoolFuukaPostsParser> = TemplateParser
