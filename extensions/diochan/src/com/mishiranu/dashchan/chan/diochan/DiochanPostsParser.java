...
public class DiochanPostsParser implements GroupParser.Callback
{
	...
	public boolean onStartElement(GroupParser parser, String tagName, String attrs)
	{
			...
			if (mPost != null)
			{
				...
				if (src != null)
				{
					...
					else if (mAttachments.size() > 0 && src.contains("/thumb/"))
					{
						...
						String width = GroupParser.extractAttr(attrs, "width");
						String height = GroupParser.extractAttr(attrs, "height");
		...
		else if ("table".equals(tagName))
		{
			...
			{
				String border = GroupParser.extractAttr(attrs, "border");
