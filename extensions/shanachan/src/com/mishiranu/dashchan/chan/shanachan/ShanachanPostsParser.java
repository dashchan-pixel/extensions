...
public class ShanachanPostsParser implements GroupParser.Callback
{
	...
	public boolean onStartElement(GroupParser parser, String tagName, String attrs)
	{
		...
		{
			if ("checkbox".equals(GroupParser.extractAttr(attrs, "type")) && "delete".equals(GroupParser.extractAttr(attrs, "name")))
			{
		...
		else if ("a".equals(tagName))
		{
			...
			{
				mAttachment.setFileUri(mLocator, mLocator.buildPath(GroupParser.extractAttr(attrs, "href")));
			}
		}
