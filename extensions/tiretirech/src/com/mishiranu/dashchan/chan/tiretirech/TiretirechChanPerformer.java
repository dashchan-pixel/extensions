...
public class TiretirechChanPerformer extends ChanPerformer {
	...
	private static class RedirectTracker implements HttpRequest.RedirectHandler {
		private final HttpRequest.RedirectHandler redirectHandler;
		...
		public Action onRedirect(HttpResponse response) throws HttpException {
			...
			return redirectHandler.onRedirect(response);
		}
	}
	...
	public ReadCaptchaResult onReadCaptcha(ReadCaptchaData data) throws HttpException, InvalidResponseException {
		...
		if (tracker.redirects.size() > 0) {
			...
			if (lastUri.getPath().startsWith("/lib/nocap/")) {
	...
	public SendDeletePostsResult onSendDeletePosts(SendDeletePostsData data) throws HttpException, ApiException,
		...
		if (data.holder.getResponseCode() != HttpURLConnection.HTTP_BAD_METHOD) {
