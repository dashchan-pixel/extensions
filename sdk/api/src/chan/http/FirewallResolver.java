...
public abstract class FirewallResolver {
	...
	public static abstract class WebViewClient<Result> {
		...
		/**
		 * <p>Get custom URI to open in WebView instead of the session URI.</p>
		 */
		public final Uri getCustomUri() {
			return BuildConfig.Private.expr();
		}

		/**
		 * <p>Set custom URI to open in WebView instead of the session URI.</p>
		 *
		 * @param customUri Custom URI.
		 */
		public final void setCustomUri(Uri customUri) {
			BuildConfig.Private.expr(customUri);
		}
