...
public final class HttpResponse {
	...
	public org.json.JSONObject getJsonObject() throws HttpException {
		try {
			return new org.json.JSONObject(readString());
		} catch (org.json.JSONException e) {
			throw new HttpException(0, e.getMessage());
		}
	}

	public org.json.JSONArray getJsonArray() throws HttpException {
		try {
			return new org.json.JSONArray(readString());
		} catch (org.json.JSONException e) {
			throw new HttpException(0, e.getMessage());
		}
	}
